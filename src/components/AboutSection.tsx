    ...
    <section className="px-6 py-8 lg:py-16" id="about" ref={ref}>
      ...
      <div className="flex flex-col w-full max-w-5xl mx-auto">
        ...
        >
          ...
          poderia ter feito, aprendi sobre back-end, front-end e mobile em apenas uma semana, também
          aprendi sobre JavaScript e decidi que aquela iria ser minha linguagem principal, não pelo
