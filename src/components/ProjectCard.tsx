...
export const ProjectCard = ({ project }: ProjectCardProps) => {
  return (
    <div className="flex flex-col w-full h-full max-w-xs">
      ...
      <h3 className="mt-4 text-lg font-normal text-gray-900 dark:text-white">{project.title}</h3>
      <p className="mb-4 text-base font-light text-gray-600 dark:text-gray-300">{project.description}</p>
